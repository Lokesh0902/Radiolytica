...
models = {
    ...
    "unet": tf.keras.models.load_model(r"C:\Users\Lokesh\Desktop\R\models\lung_segmentation_unet.h5")
}
...
def upload_file():
    ...
    notebooks = [
    {'name': 'pneumonia', 'path': './notebooks/Pneumonia_gradcam.ipynb'},
    {'name': 'tb', 'path': './notebooks/Tuberculosis_gradcam.ipynb'},
    {'name': 'cardiomegaly', 'path': './notebooks/CTR_1.ipynb'}
    ]
